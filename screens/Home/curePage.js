  ...
  const [users, setUsers] = useState([]);
   const [orderId, setOrderId] = useState();
    ...
    const saveUsers = async () => {
        if (state.insured_name === ''){
            // alert('Please fill the details')
            ToastAndroid.show('Please fill the complete details',
            ToastAndroid.LONG
          )
        }else{
           await db.collection('aidnCure').doc('user'+ userData.uid).set({
                name : state.name,
                gender: state.gender,
                age: state.age,
                proposer_email: state.proposer_email,
                proposer_address_1: state.proposer_address_1,
                proposer_address_2: state.proposer_address_2,
                relation:state.relation,
                insured_title:state.insured_title,
                insured_dob:state.insured_dob,
                insured_name:state.insured_name,
                nominee_title:state.nominee_title,
                nominee_dob:state.nominee_dob,
                nominee_name:state.nominee_name,
                nominee_relation:state.nominee_relation,
                proposer_phone:state.proposer_phone,
                uid:userData.uid,
            })
          ...
          RazorpayCheckout.open(options).then((data) => {
            ...
            const userData = firebase.auth().currentUser;
            db.collection('aidnCure').doc('user'+ userData.uid).update({
              order_id : orderId,
    ...
    {/* <StatusBar backgroundColor="#000" /> */}
      ...
      <View style={{
        ...
        >Policy Type: Acci care + Unlimited Teleconsultation </Text>
      </View>
      ...
      <View style={styles.nameContainer}>
          <TextInput        
            ...
            placeholder='Proposer Full name'
            // value={fullName}
      ...
      <View style={styles.emailContainer}>
          <TextInput        
            ...
            // value={occupation}
            onChangeText={(value) => handleChangeText('proposer_email', value)}
      ...
      <View style={styles.emailContainer}>
          <TextInput  
            ...
            placeholderTextColor= "#000"
            // placeholderTextColor= "#fff" 
            placeholder='Proposer Address 1'
            // onChangeText={(text) => setproposer_address_1(text)}
            // value={proposer_address_1}
            onChangeText={(value) => handleChangeText('proposer_address_1', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      ...
      <View style={styles.emailContainer}>
          <TextInput  
            ...
            placeholderTextColor= "#000"
            // placeholderTextColor= "#fff" 
            placeholder='Proposer Address 2'
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('proposer_address_2', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      ...
      <View style={styles.emailContainer}>
          <TextInput        
            placeholderTextColor= "#000"
            // placeholderTextColor= "#fff" 
            placeholder='Relation of proposer'
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('relation', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      onPress={()=>{Keyboard.dismiss();}}
      >
      <View style={styles.nomineeTitle}>
          <TextInput        
            placeholderTextColor= "#000"
            // placeholderTextColor= "#fff" 
            ...
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('nominee_title', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      ...
      <View style={styles.nomineeDOB}>
          <TextInput        
            ...
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('nominee_dob', value)}
            keyboardType="phone-pad"
            />
      </View>
      </TouchableWithoutFeedback>
      ...
      <View style={styles.emailContainer}>
          <TextInput        
            ...
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('nominee_name', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      ...
      <View style={styles.emailContainer}>
          <TextInput        
            ...
            // onChangeText={(text) => setFrom(text)}
            // value={from}
            onChangeText={(value) => handleChangeText('nominee_relation', value)}
            />
      </View>
      </TouchableWithoutFeedback>

      {/* User Personal proposer_phone number */}
      ...
      <View style={styles.emailContainer}>
          <TextInput        
            placeholderTextColor= "#000"
            placeholder='Proposer Phone number'
            onChangeText={(value) => handleChangeText('proposer_phone', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      onPress={()=>{Keyboard.dismiss();}}
      >
      <View style={styles.proposerTitle}>
          <TextInput        
            placeholderTextColor= "#000"
            placeholder='Insured Person Title'
            onChangeText={(value) => handleChangeText('insured_title', value)}
            />
      </View>
      </TouchableWithoutFeedback>
      <TouchableWithoutFeedback
      onPress={()=>{Keyboard.dismiss();}}
      >
      <View style={styles.proposerDOB}>
          <TextInput        
            placeholderTextColor= "#000"
            placeholder='Insured Person DOB'
            onChangeText={(value) => handleChangeText('insured_dob', value)}
            keyboardType="phone-pad"
            />
      </View>
      </TouchableWithoutFeedback>
      ...
      <View style={styles.proposerContainer}>
          <TextInput        
            placeholderTextColor= "#000"
            placeholder='Insured Person Full Name'
            onChangeText={(value) => handleChangeText('insured_name', value)}
            />
      </View>
      </TouchableWithoutFeedback>
